# Requirements Archive: v1.1 Domain, housekeeping & feature documentation

**Archived:** 2026-04-12
**Status:** SHIPPED

Historical snapshot only. **Current** requirements: `.planning/REQUIREMENTS.md` (reset after this archive).
