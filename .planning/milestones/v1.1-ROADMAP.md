# Archived roadmap snapshot — v1.1 completion

**Archived:** 2026-04-12 — full roadmap at milestone close (Phases 1–8). For the living roadmap, see `.planning/ROADMAP.md`.
