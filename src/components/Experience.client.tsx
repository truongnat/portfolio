                    ...
                    {experiences.map((exp, index) => (
                        ...
                        >
                            ...
                            <div className="flex-1 md:w-1/2">
                                <div className="bg-card/40 backdrop-blur-xl border border-white/5 rounded-xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:bg-card/50 hover:border-primary/40 hover:-translate-y-1">
